            ...
            <div class="card-body p-4 d-flex align-items-center">
              <div class="user-info">
                <p class="mb-0 text-dark">
                  {{ formData.auction.title }}
                </p>
                <h5 class="mb-0">
                  مبلغ پرداختی : {{ formData.auction.input_price }}
                </h5>
              </div>
            </div>
          </div>
              ...
              <form action="" method="">
                ...
                <div class="col-6 mb-3">
                  <div class="title mb-2">
                    <i class="lni lni-user" /><span>نام</span>
                  </div>
                  <input class="form-control" type="text"  v-model="formData.user.first_name" >
                </div>
                <div class="col-6 mb-3">
                  <div class="title mb-2">
                    <i class="lni lni-user" /><span>نام خانوادگی</span>
                  </div>
                  <input class="form-control" type="text" v-model="formData.user.last_name">
                </div>
                </div>
                <div class="mb-3">
                  <div class="title mb-2">
                    <i class="lni lni-money-protection" /><span>مبلغ پیشنهادی(تومان)</span>
                  </div>
                  <input class="form-control" type="text" v-model="price" >
                </div>
                <button class="btn btn-success w-100" type="submit">
                  ثبت پیشنهاد و پرداخت بیعانه
                </button>
              </form>
            </div>
          </div>
