        ...
        <div class="cart-wrapper-area py-3">
          <div class="card cart-amount-area mb-3">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <a class="btn btn-warning" href="/create">جدید</a>
            </div>
          </div>
          <div class="card cart-amount-area mb-3">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <table class="table mb-0">
                <tbody>
                  <tr>
                    ...
                    <td>کاربری</td>
                    <td>پرداختی از</td>
                    <td>کل مبلغ پرداختی</td>
                    <td>سودکاربر</td>
                    <td>سودشرکت</td>
                    <td>سود معرفین</td>
                    <td>سود مسئول اجرایی</td>
                    <td>پرداختی به پذیرنده</td>
                  </tr>
                  <tr v-for="(item, count) in formData.shopData" :key="item.id">
                    ...
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.shop_manager }}</a>
                    </td>
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.shop_username }}</a>
                    </td>
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.city }}</a>
                    </td>
                    ...
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.profit_user }}</a>
                    </td>
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.profit_company }}</a>
                    </td>
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.profit_parent }}</a>
                    </td>
                    <td style="min-width: 200px;">
                      <a href="#">{{ item.profit_representer }}</a>
                    </td>
                    <td style="min-width: 200px;">
...
export default {
  ...
  created () {
    ...
    axios
      .post('https://karjico.ir/api/admin/shop/report', formDataV,
        {
          headers: {
