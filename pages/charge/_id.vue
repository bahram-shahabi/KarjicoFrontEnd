              ...
              <div class="col-12">
                <div class="card shopCart">
                  <div class="card user-data-card bg-dark">
                    <div v-if="id==='sim'" class="card-body">
                      <div>
                        <div class="title align-items-center">
                          ...
                          <div class="line" />
                          <a href="/charge/simcart">
                          <p class="border2 border-yellow color-yellow">
                            <img class="sim-img" src="~/assets/img/chargeplus.png" alt="">
                           خرید شارژ
                          </p>
                          </a>
                          <a href="/charge/transfer">
                          <p class="border2 border-yellow color-yellow">
                            <img class="sim-img" src="~/assets/img/chargeplusA.png" alt="">
                            انتقال شارژ
                          </p>
                          </a>
                          <a  href="tel:*10*121#">
                          <p class="border2 border-yellow color-yellow">
                            <img class="sim-img" src="~/assets/img/chargeplusQ.png" alt="">
                            استعلام موجودی شارژ
                          </p>
                          </a>
                        </div>
                    ...
                    <div v-if="id==='net'" class="card-body">
                      <div>
                        <div class="title align-items-center">
                          <h5 class="mb-0 titleBorder">
                            خدمات خرید اینترنت
                          ...
                          <div class="line" />
                          <a href="/charge/internet">
                            <p class="border2 border-yellow color-yellow">
                              <img class="sim-img" src="~/assets/img/chargeNetPlus.png" alt="">
                              خرید بسته اینترنتی
                            </p>
                          </a>
                          <p class="border2 border-yellow color-yellow">
                            <img class="sim-img" src="~/assets/img/chargeplusA.png" alt="">
                            استعلام بسته اینترنتی
                          </p>
                        </div>
                      </div>
                    </div>
